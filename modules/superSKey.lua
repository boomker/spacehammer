...
if spoon.ModalMgr then
    ...
    skmodal:bind('', 'Z', '显示桌面',
        function() hs.spaces.toggleShowDesktop() spoon.ModalMgr:deactivate({ "SuperSKey" }) end)
    skmodal:bind('', 'S', 'KSheet看应用热键',
        function() showAppShortCutsPane() spoon.ModalMgr:deactivate({ "SuperSKey" }) end)
    skmodal:bind('', 'W', '显示窗口管理所有热键',
        function() showHSHotKeysPane('WindowMOnly') spoon.ModalMgr:deactivate({ "SuperSKey" }) end)
    skmodal:bind('', 'H', '打开快捷键显示面板',
        function() showHSHotKeysPane("all") spoon.ModalMgr:deactivate({ "SuperSKey" }) end)
