...
if spoon.ModalMgr then
	...
	skmodal:bind('', 'escape', 'exit SuperSKey模式', function() spoon.ModalMgr:deactivate({"SuperSKey"}) end)
	skmodal:bind('', 'Q', 'exit SuperSKey模式', function() spoon.ModalMgr:deactivate({"SuperSKey"}) end)
    skmodal:bind('', 'tab', '键位提示', function() spoon.ModalMgr:toggleCheatsheet() end)
	skmodal:bind('', 'Z', '显示桌面', function() hs.spaces.toggleShowDesktop() spoon.ModalMgr:deactivate({"SuperSKey"}) end)
	skmodal:bind('', 'S', 'KSheet看应用热键', function() showAppShortCutsPane() spoon.ModalMgr:deactivate({"SuperSKey"}) end)
	skmodal:bind('', 'W', 'KSheet看应用热键', function()showHSHotKeysPane('WindowMOnly') spoon.ModalMgr:deactivate({"SuperSKey"}) end)
	skmodal:bind('', 'H', '打开快捷键显示面板', function() showHSHotKeysPane("all") spoon.ModalMgr:deactivate({"SuperSKey"}) end)
