...
if spoon.ModalMgr then
	...
	skmodal:bind('', 'S', 'KSheet看应用热键', function() enterCheatsheetM() spoon.ModalMgr:deactivate({"SuperSKey"}) end)
	skmodal:bind('', 'H', '打开快捷键显示面板', function() enterShowHSHotKeyPane() spoon.ModalMgr:deactivate({"SuperSKey"}) end)
